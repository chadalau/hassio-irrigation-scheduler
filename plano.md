...
Mesma casca visual do card de água — cabeçalho, badge de status, lista de horários em
caixas com borda arredondada (indicador de dia + ícone de resultado), botão de largura
total "Adicionar horário" e barra de execução ao vivo com o botão de parar ao lado da
barra — só sem os badges de reservatório/pH que não fazem sentido aqui.
...
├─────────────────────────────────────────┤
│ ● Ligada desde 06:00      2:34:10 restam │
│ ▓▓▓▓▓▓▓▓▓▓▓▓░░░░░░░░░░░░   [■ Desligar]  │
├─────────────────────────────────────────┤
│ ┌───────────────────────────────────────┐ │
│ │ ⏻ 18:30  S T Q Q S S D         ✎  🗑 │ │
