                  ...
                  ${E&&C?L`
                        ...
                        <div class="water-now-progress">
                          <div class="water-now-timer">
                            ${function(t){const e=Math.max(0,Math.floor(Number.isFinite(t)?t:0)),i=Math.floor(e/3600),s=Math.floor(e%3600/60),r=e%60,o=String(s).padStart(2,"0"),n=String(r).padStart(2,"0");return i>0?`${i}:${o}:${n}`:`${o}:${n}`}(T)} restantes${"external"===N?` · ${Rt(N)}`:""}
                          </div>
