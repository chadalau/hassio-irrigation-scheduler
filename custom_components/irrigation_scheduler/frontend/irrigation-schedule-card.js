...
`,xt=["Seg","Ter","Qua","Qui","Sex","Sáb","Dom"],$t=/^(\d{1,2}):(\d{1,2})(?::(\d{1,2}))?$/;function wt(t){const e=$t.exec(t);if(!e)return null;const i=Number(e[1]),s=Number(e[2]),r=e[3]?Number(e[3]):0;return i>23||s>59||r>59?null:{hour:i,minute:s,second:r}}function Et(t){const e=wt(t);if(!e)return t;const i=t.slice(0,t.indexOf(":")),s=String(e.minute).padStart(2,"0");return e.second>0?`${i}:${s}:${String(e.second).padStart(2,"0")}`:`${i}:${s}`}function St(){return[...xt]}function At(t){const e=Math.max(0,Math.round(Number.isFinite(t)?t:0));if(e<60)return`${e} s`;const i=Math.round(e/60),s=Math.floor(i/60),r=i%60,n=[];return s>0&&n.push(`${s} h`),r>0&&n.push(`${r} min`),n.join(" ")}function Dt(t,e){const i=function(t,e){const i=Number.isFinite(t)?t:0;return i<=0?null:i/3600*(Number.isFinite(e)?Math.max(0,e):0)}(t,e);return null===i?null:1e3*i}function Ct(t,e,i){const s=Dt(t,e);if(null===s)return null;return s*(Number.isFinite(i)&&i>0?i:1)}function Mt(t){return Number.isFinite(t)?t>=1e3?(e=t/1e3,Number.isFinite(e)?Math.round(100*e)/100+" L":"0 L"):Math.round(100*t)/100+" ml":"0 ml";var e}function kt(t){const e=wt(t);return e?3600*e.hour+60*e.minute+e.second:-1}function Pt(t,e){if(!Number.isFinite(t))return"?";const i=Math.round(100*t)/100;return e?`${i} ${e}`:`${i}`}function Nt(t){const e=wt(t);if(!e)return t;return`${String(e.hour).padStart(2,"0")}:${String(e.minute).padStart(2,"0")}:${String(e.second).padStart(2,"0")}`}function Tt(t,e){return new Intl.DateTimeFormat("en-CA",{timeZone:e,year:"numeric",month:"2-digit",day:"2-digit"}).format(t)}function Rt(t,e,i){const s=new Date(t);if(Number.isNaN(s.getTime()))return"";const r=new Date(e);if(Tt(s,i)===Tt(r,i))return"Hoje";const n=new Date(r.getTime()-864e5);return Tt(s,i)===Tt(n,i)?"Ontem":new Intl.DateTimeFormat("pt-BR",{timeZone:i,day:"2-digit",month:"2-digit"}).format(s)}function zt(t){return"manual"===t?"manual":"external"===t?"ativada no dispositivo":"agendada"}function Ht(t,e,i,s,r){if(e)return"warning";if(!t.enabled)return null;const n=new Date(s);if(Number.isNaN(n.getTime()))return null;if(!t.days.includes(function(t,e){const i=new Intl.DateTimeFormat("en-US",{timeZone:e,weekday:"short"}).format(t),s=["Mon","Tue","Wed","Thu","Fri","Sat","Sun"].indexOf(i);return s>=0?s:(t.getDay()+6)%7}(n,r)))return null;const o=kt(t.time);if(o<0)return null;if(function(t,e){const i=new Intl.DateTimeFormat("en-GB",{timeZone:e,hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!1}).formatToParts(t),s=t=>Number(i.find(e=>e.type===t)?.value??0);return s("hour")%24*3600+60*s("minute")+s("second")}(n,r)<o)return"pending";const a=Tt(n,r);return i.some(e=>{const i=new Date(e.started_at);return e.schedule_id===t.id&&!Number.isNaN(i.getTime())&&Tt(i,r)===a})?"done":null}function Ot(t){if(!t||"object"!=typeof t)throw new Error("Configuração inválida para o card de irrigação.");const e=t.entity;if("string"!=typeof e||0===e.length||!e.startsWith("sensor."))throw new Error('O card exige um sensor da integração: "sensor.<zona>_next_run".')}class Ft extends at{constructor(){super(...arguments),this._config={type:"custom:irrigation-schedule-card"},this._now=0,this._dialogOpen=!1,this._historyOpen=!1,this._settingsOpen=!1,this._focusBeforeDialog=null,this._settingsDefaultDuration="",this._settingsFlow="",this._settingsPots="",this._settingsReservoir="",this._settingsPhEntity="",this._settingsPhEntityTouched=!1,this._settingsPhMin="",this._settingsPhMax="",this._settingsEcEntity="",this._settingsEcEntityTouched=!1,this._settingsPhEntity2="",this._settingsPhEntity2Touched=!1,this._settingsPhMin2="",this._settingsPhMax2="",this._settingsEcEntity2="",this._settingsEcEntity2Touched=!1,this._settingsError=null,this._editingId=null,this._formTime="06:00",this._formDays=[],this._formDurationHour=0,this._formDurationMin=15,this._formDurationSec=0,this._formError=null,this._tickerId=null}static{this.styles=bt}static getConfigElement(){return document.createElement("irrigation-schedule-card-editor")}static getStubConfig(){return{show_next_run:gt,show_water_now:mt,compact:_t}}setConfig(t){Ot(t),this._config={...t}}getCardSize(){return this._config.compact?2:4}disconnectedCallback(){super.disconnectedCallback(),this._stopTicker()}updated(t){super.updated(t),this._isWatering()?null===this._tickerId&&(this._tickerId=window.setInterval(()=>{this._now=Date.now()},1e3)):null!==this._tickerId&&this._stopTicker()}render(){if(!this.hass)return this._renderConfigError("O card ainda não recebeu o objeto hass do Home Assistant.");try{if(!this._config.entity)return this._renderConfigError("Configure o card com o sensor da zona: sensor.<zona>_next_run.");if(!this._config.entity.startsWith("sensor."))return this._renderConfigError(`"${this._config.entity}" não é um sensor da integração irrigation_scheduler.`);const t=this._sensorEntity;return t?"switch_entity_id"in t.attributes&&"binary_sensor_entity_id"in t.attributes?this._renderCard(t):this._renderConfigError(`"${this._config.entity}" não é um sensor da integração irrigation_scheduler.`):this._renderConfigError(`Entidade "${this._config.entity}" não encontrada.`)}catch(t){return console.error("[irrigation-schedule-card] render failed",t),this._renderConfigError(`Falha ao renderizar o card: ${t instanceof Error?t.message:String(t)}`)}}_renderConfigError(t){return L`
    ...
    `}_renderCard(t){const e=this._config.compact??_t,i=this._config.show_next_run??gt,s=this._config.show_water_now??mt,r=St(),n=function(t){return[...t].sort((t,e)=>kt(t.time)-kt(e.time))}(function(t){if(!Array.isArray(t))return[];const e=[];for(const i of t){if(null===i||"object"!=typeof i)continue;const t=i,s="string"==typeof t.time&&null!==wt(t.time)?Nt(t.time):"",r=Array.isArray(t.days)?t.days.filter(t=>"number"==typeof t&&Number.isInteger(t)&&t>=0&&t<=6):[],n="number"==typeof t.duration&&Number.isFinite(t.duration)&&t.duration>0?t.duration:0;!s||0===r.length||n<=0||e.push({id:"string"==typeof t.id?t.id:"",time:s,days:[...new Set(r)].sort((t,e)=>t-e),duration:n,enabled:"boolean"!=typeof t.enabled||t.enabled})}return e}(t.attributes.schedules)),o=this._numberAttr(t,"default_duration")??600,a=this._numberAttr(t,"flow_rate_lph")??0,l=this._numberAttr(t,"number_of_pots")??0,c=this._numberAttr(t,"reservoir_volume_l")??0,d=this._numberAttr(t,"reservoir_remaining_l")??c,h=this._stringAttr(t,"ph_entity_id")??"",u=this._numberAttr(t,"ph_min")??0,p=this._numberAttr(t,"ph_max")??14,g=this._phStatusClass(h,u,p),m=this._stringAttr(t,"ec_entity_id")??"",_=this._stringAttr(t,"ph_entity_id_2")??"",f=this._numberAttr(t,"ph_min_2")??0,v=this._numberAttr(t,"ph_max_2")??14,y=this._phStatusClass(_,f,v),b=this._stringAttr(t,"ec_entity_id_2")??"",x=this._scheduleWarnings(t),$=this._switchEid?this.hass?.states[this._switchEid]:void 0,w=this._binarySensorEid?this.hass?.states[this._binarySensorEid]:void 0,E="on"===w?.state,S="on"===$?.state,A=E?"Regando":S?"Agendada":"Desabilitada",D=E?"status-watering":S?"status-scheduled":"status-disabled",C=this._stringAttr(w,"finishes_at"),M=this._stringAttr(w,"started_at"),k=this._stringAttr(w,"source"),P=this._now>0?new Date(this._now).toISOString():(new Date).toISOString(),N=C?function(t,e){const i=Date.parse(t),s=Date.parse(e);return Number.isFinite(i)&&Number.isFinite(s)?Math.max(0,Math.floor((i-s)/1e3)):0}(C,P):0,T=M&&C?function(t,e,i){const s=Date.parse(t),r=Date.parse(e),n=Date.parse(i);if(!Number.isFinite(s)||!Number.isFinite(r)||!Number.isFinite(n))return 0;const o=s-r;return o<=0?100:Math.min(100,Math.max(0,(n-r)/o*100))}(C,M,P):0,R=this._lastRunAttr(w),z=this._historyAttr(w),H=c>0?L`<span class="sensor-badge volume-badge"
      ...
      <ha-card class=${e?"compact":""}>
        ...
        ${R?L`
              <div class="last-run" @click=${this._openHistory}>
                ...
                <span>Última rega: ${this._lastRunText(R,P)}</span>
        ...
        <div class="card-body">
          <div class="schedules">
            ${0===n.length?L`<div class="empty">Nenhum horário configurado.</div>`:n.map(t=>this._renderScheduleRow(t,a,l,x[t.id],z,P,this.hass?.config?.time_zone))}
          </div>
      ...
      ${this._renderHistoryDialog(z,this._zoneName(t),P)}
    `}_renderReservoirRow(t,e,i,s,r,n,o,a){const l=i?L`
          ...
          >
            ${this._sensorBadgeText(i,"pH ?",t=>`${Pt(t)} PH`)}
          </button>
        `:L`<span></span>`,c=r?L`
          <button
          ...
          >
            ${this._sensorBadgeText(r,"EC ?",(t,e)=>`EC ${Pt(t,e)}`)}
          </button>
        `:L`<span></span>`;return[t?L`<span class="reservoir-label">${t}</span>`:L`<span></span>`,l,c,n,o,a]}_renderScheduleRow(t,e,i,s,r,n,o){const a=Dt(e,t.duration),l=Ct(e,t.duration,i),c=Ht(t,Boolean(s),r,n,o);return L`
      <div class="schedule-row">
        ...
        <div class="schedule-info">
          ...
          <div class="schedule-duration">
            ${At(t.duration)}
            ${null!==l?L`<span class="schedule-volume">· ≈ ${Mt(l)}</span>`:""}
            ${null!==l&&null!==a?L`<span class="schedule-perpot">· ${Mt(a)}/vaso</span>`:""}
          </div>
        </div>
      ...
      <div class="overlay" @click=${this._closeHistory}>
        ...
        >
          ...
          <div class="history-stats">
            ...
            <div class="history-stat">
              <span class="history-stat-value">${Mt(r)}</span>
    ...
    `}_renderHistoryEntry(t){const e=new Date(t.started_at),i=Number.isNaN(e.getTime())?"":new Intl.DateTimeFormat("pt-BR",{timeZone:this.hass?.config?.time_zone,hour:"2-digit",minute:"2-digit"}).format(e),s=Dt(t.flow_rate_lph,t.duration);return L`
      <div class="history-entry">
        ...
        <span class="history-entry-detail">
          ${At(t.duration)}
          ${null!==s?L` · ${Mt(s)}/vaso`:""}
          ${null!==t.ph_value?L` · ${Pt(t.ph_value)} PH`:""}
          ${null!==t.ec_value?L` · EC ${Pt(t.ec_value,t.ec_unit??void 0)}`:""}
          ${"number"==typeof t.ph_value_2?L` · ${Pt(t.ph_value_2)} PH R2`:""}
          ${"number"==typeof t.ec_value_2?L` · EC ${Pt(t.ec_value_2,t.ec_unit_2??void 0)} R2`:""}
        </span>
      </div>
