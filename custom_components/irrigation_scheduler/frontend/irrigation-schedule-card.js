...
`,xt=["Seg","Ter","Qua","Qui","Sex","Sáb","Dom"],$t=/^(\d{1,2}):(\d{1,2})(?::(\d{1,2}))?$/;function wt(t){const e=$t.exec(t);if(!e)return null;const i=Number(e[1]),r=Number(e[2]),s=e[3]?Number(e[3]):0;return i>23||r>59||s>59?null:{hour:i,minute:r,second:s}}function Et(t){const e=wt(t);if(!e)return t;const i=t.slice(0,t.indexOf(":")),r=String(e.minute).padStart(2,"0");return e.second>0?`${i}:${r}:${String(e.second).padStart(2,"0")}`:`${i}:${r}`}function St(){return[...xt]}function At(t){const e=Math.max(0,Math.round(Number.isFinite(t)?t:0));if(e<60)return`${e} s`;const i=Math.round(e/60),r=Math.floor(i/60),s=i%60,n=[];return r>0&&n.push(`${r} h`),s>0&&n.push(`${s} min`),n.join(" ")}function kt(t){if(!Number.isFinite(t))return"0 L";return`${Math.round(100*t)/100} L`}function Dt(t,e){const i=function(t,e){const i=Number.isFinite(t)?t:0;return i<=0?null:i/3600*(Number.isFinite(e)?Math.max(0,e):0)}(t,e);return null===i?null:1e3*i}function Mt(t,e,i){const r=Dt(t,e);if(null===r)return null;return r*(Number.isFinite(i)&&i>0?i:1)}function Ct(t){return Number.isFinite(t)?t>=1e3?kt(t/1e3):Math.round(100*t)/100+" ml":"0 ml"}function Pt(t){const e=wt(t);return e?3600*e.hour+60*e.minute+e.second:-1}function Nt(t,e){if(!Number.isFinite(t))return"?";const i=Math.round(100*t)/100;return e?`${i} ${e}`:`${i}`}function zt(t){const e=wt(t);if(!e)return t;return`${String(e.hour).padStart(2,"0")}:${String(e.minute).padStart(2,"0")}:${String(e.second).padStart(2,"0")}`}function Tt(t,e){return new Intl.DateTimeFormat("en-CA",{timeZone:e,year:"numeric",month:"2-digit",day:"2-digit"}).format(t)}function Rt(t,e,i){const r=new Date(t);if(Number.isNaN(r.getTime()))return"";const s=new Date(e);if(Tt(r,i)===Tt(s,i))return"Hoje";const n=new Date(s.getTime()-864e5);return Tt(r,i)===Tt(n,i)?"Ontem":new Intl.DateTimeFormat("pt-BR",{timeZone:i,day:"2-digit",month:"2-digit"}).format(r)}function Ht(t){return"manual"===t?"manual":"external"===t?"ativada no dispositivo":"agendada"}function Ot(t,e){const i=new Intl.DateTimeFormat("en-US",{timeZone:e,weekday:"short"}).format(t),r=["Mon","Tue","Wed","Thu","Fri","Sat","Sun"].indexOf(i);return r>=0?r:(t.getDay()+6)%7}function Ft(t,e,i,r,s){if(e)return"warning";if(!t.enabled)return null;const n=new Date(r);if(Number.isNaN(n.getTime()))return null;if(!t.days.includes(Ot(n,s)))return null;const o=Pt(t.time);if(o<0)return null;if(function(t,e){const i=new Intl.DateTimeFormat("en-GB",{timeZone:e,hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!1}).formatToParts(t),r=t=>Number(i.find(e=>e.type===t)?.value??0);return r("hour")%24*3600+60*r("minute")+r("second")}(n,s)<o)return"pending";const a=Tt(n,s);return i.some(e=>{const i=new Date(e.started_at);return e.schedule_id===t.id&&!Number.isNaN(i.getTime())&&Tt(i,s)===a})?"done":null}function It(t){if(!t||"object"!=typeof t)throw new Error("Configuração inválida para o card de irrigação.");const e=t.entity;if("string"!=typeof e||0===e.length||!e.startsWith("sensor."))throw new Error('O card exige um sensor da integração: "sensor.<zona>_next_run".')}class jt extends at{constructor(){super(...arguments),this._config={type:"custom:irrigation-schedule-card"},this._now=0,this._dialogOpen=!1,this._historyOpen=!1,this._settingsOpen=!1,this._focusBeforeDialog=null,this._settingsDefaultDuration="",this._settingsFlow="",this._settingsPots="",this._settingsReservoir="",this._settingsPhEntity="",this._settingsPhEntityTouched=!1,this._settingsPhMin="",this._settingsPhMax="",this._settingsEcEntity="",this._settingsEcEntityTouched=!1,this._settingsPhEntity2="",this._settingsPhEntity2Touched=!1,this._settingsPhMin2="",this._settingsPhMax2="",this._settingsEcEntity2="",this._settingsEcEntity2Touched=!1,this._settingsError=null,this._editingId=null,this._formTime="06:00",this._formDays=[],this._formDurationHour=0,this._formDurationMin=15,this._formDurationSec=0,this._formError=null,this._tickerId=null}static{this.styles=bt}static getConfigElement(){return document.createElement("irrigation-schedule-card-editor")}static getStubConfig(){return{show_next_run:gt,show_water_now:mt,compact:_t}}setConfig(t){It(t),this._config={...t}}getCardSize(){return this._config.compact?2:4}disconnectedCallback(){super.disconnectedCallback(),this._stopTicker()}updated(t){super.updated(t),this._isWatering()?null===this._tickerId&&(this._tickerId=window.setInterval(()=>{this._now=Date.now()},1e3)):null!==this._tickerId&&this._stopTicker()}render(){if(!this.hass)return this._renderConfigError("O card ainda não recebeu o objeto hass do Home Assistant.");try{if(!this._config.entity)return this._renderConfigError("Configure o card com o sensor da zona: sensor.<zona>_next_run.");if(!this._config.entity.startsWith("sensor."))return this._renderConfigError(`"${this._config.entity}" não é um sensor da integração irrigation_scheduler.`);const t=this._sensorEntity;return t?"switch_entity_id"in t.attributes&&"binary_sensor_entity_id"in t.attributes?this._renderCard(t):this._renderConfigError(`"${this._config.entity}" não é um sensor da integração irrigation_scheduler.`):this._renderConfigError(`Entidade "${this._config.entity}" não encontrada.`)}catch(t){return console.error("[irrigation-schedule-card] render failed",t),this._renderConfigError(`Falha ao renderizar o card: ${t instanceof Error?t.message:String(t)}`)}}_renderConfigError(t){return L`
    ...
    `}_renderCard(t){const e=this._config.compact??_t,i=this._config.show_next_run??gt,r=this._config.show_water_now??mt,s=St(),n=function(t){return[...t].sort((t,e)=>Pt(t.time)-Pt(e.time))}(function(t){if(!Array.isArray(t))return[];const e=[];for(const i of t){if(null===i||"object"!=typeof i)continue;const t=i,r="string"==typeof t.time&&null!==wt(t.time)?zt(t.time):"",s=Array.isArray(t.days)?t.days.filter(t=>"number"==typeof t&&Number.isInteger(t)&&t>=0&&t<=6):[],n="number"==typeof t.duration&&Number.isFinite(t.duration)&&t.duration>0?t.duration:0;!r||0===s.length||n<=0||e.push({id:"string"==typeof t.id?t.id:"",time:r,days:[...new Set(s)].sort((t,e)=>t-e),duration:n,enabled:"boolean"!=typeof t.enabled||t.enabled})}return e}(t.attributes.schedules)),o=this._numberAttr(t,"default_duration")??600,a=this._numberAttr(t,"flow_rate_lph")??0,l=this._numberAttr(t,"number_of_pots")??0,c=this._numberAttr(t,"reservoir_volume_l")??0,d=this._numberAttr(t,"reservoir_remaining_l")??c,h=this._stringAttr(t,"ph_entity_id")??"",u=this._numberAttr(t,"ph_min")??0,p=this._numberAttr(t,"ph_max")??14,g=this._phStatusClass(h,u,p),m=this._stringAttr(t,"ec_entity_id")??"",_=this._stringAttr(t,"ph_entity_id_2")??"",f=this._numberAttr(t,"ph_min_2")??0,v=this._numberAttr(t,"ph_max_2")??14,y=this._phStatusClass(_,f,v),b=this._stringAttr(t,"ec_entity_id_2")??"",x=this._scheduleWarnings(t),$=this._switchEid?this.hass?.states[this._switchEid]:void 0,w=this._binarySensorEid?this.hass?.states[this._binarySensorEid]:void 0,E="on"===w?.state,S="on"===$?.state,A=E?"Regando":S?"Agendada":"Desabilitada",k=E?"status-watering":S?"status-scheduled":"status-disabled",D=E?"mdi:water":S?"mdi:calendar-check":"mdi:calendar-remove",M=this._stringAttr(w,"finishes_at"),C=this._stringAttr(w,"started_at"),P=this._stringAttr(w,"source"),N=this._now>0?new Date(this._now).toISOString():(new Date).toISOString(),z=M?function(t,e){const i=Date.parse(t),r=Date.parse(e);return Number.isFinite(i)&&Number.isFinite(r)?Math.max(0,Math.floor((i-r)/1e3)):0}(M,N):0,T=C&&M?function(t,e,i){const r=Date.parse(t),s=Date.parse(e),n=Date.parse(i);if(!Number.isFinite(r)||!Number.isFinite(s)||!Number.isFinite(n))return 0;const o=r-s;return o<=0?100:Math.min(100,Math.max(0,(n-s)/o*100))}(M,C,N):0,R=this._lastRunAttr(w),H=this._historyAttr(w),O=function(t,e,i){let r=0;for(const s of t){if(!s.enabled)continue;const t=Mt(e,s.duration,i);null!==t&&(r+=t*s.days.length)}return r/1e3/7}(n,a,l),F=function(t,e){if(!Number.isFinite(e)||e<=0)return null;const i=Number.isFinite(t)?Math.max(0,t):0;if(i<=0)return"Vazio";const r=i/e;if(r<1)return`~${Math.max(1,Math.round(24*r))} h`;return r<=60?`~${Math.max(1,Math.round(r))} dias`:`~${Math.max(1,Math.round(r/30))} meses`}(d,O),I=function(t,e,i){const r=new Date(e);if(Number.isNaN(r.getTime()))return 0;const s=Ot(r,i);return t.filter(t=>t.enabled&&t.days.includes(s)).length}(n,N,this.hass?.config?.time_zone),j=c>0?Math.min(100,Math.max(0,d/c*100)):0,U=c>0?L`
          ...
          `:"",B=Boolean(h||m||c>0),W=Boolean(_||b);return L`
      <ha-card class=${e?"compact":""}>
              ...
              <div class="watering-bar">
                <div class="watering-info">
                  ...
                  <div class="watering-remaining">
                    ${function(t){const e=Math.max(0,Math.floor(Number.isFinite(t)?t:0)),i=Math.floor(e/3600),r=Math.floor(e%3600/60),s=e%60,n=String(r).padStart(2,"0"),o=String(s).padStart(2,"0");return i>0?`${i}:${n}:${o}`:`${n}:${o}`}(z)} restantes
                  </div>
                </div>
        ...
        ${B||W?L`
              ...
              <div class="card-body">
                ...
                <div class="metrics">
                  ${B?this._renderReservoirMetrics(W?" R1":"",1,h,g,m):""}
                  ${W?this._renderReservoirMetrics(B?" R2":"",2,_,y,b):""}
                </div>
                ${c>0?L`
